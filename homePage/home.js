...
// links info -> 0: logo, 1/2/3/4/5: home directory, last index: language
let links_v1 = [ // 15 pages
  "./images/logo.png",
  "./home.html",
  "./aboutus.html",
  "./special-offers.html",
  ...
  "../rita.html",
  // stay last
  "./ar/homePage/home.html"
];

let links_v2 = [ // 15 pages
  ...
  "./rita.html",
  // stay last
  "./homePage/ar/homePage/home.html"
];
